...
var WETH =
  ...
  (_WETH[ChainId.GÖRLI] = /*#__PURE__*/ new Token(
    ChainId.GÖRLI,
    '0x626B5c394542960faa9495e64E812d17D5B605F9',
    18,
    'WETH',
    'Wrapped Ether'
  )),
      ...
      PAIR_ADDRESS_CACHE = _extends(
        ...
        (_extends3[tokens[0].address] = _extends(
          ...
          (_extends2[tokens[1].address] = getCreate2Address(
            FACTORY_ADDRESS(tokenA.chainId, is721Pair),
            keccak256(['bytes'], [pack(['address', 'address'], [tokens[0].address, tokens[1].address])]),
            INIT_CODE_HASH(tokenA.chainId, is721Pair)
          )),
          _extends2)
        )),
        _extends3)
    ...
    switch (trade.tradeType) {
      case TradeType.EXACT_INPUT:
        if (etherIn) {
          ...
          args = tokenIds
            ? [amountIn, amountOut, path, tokenIds, to, deadline]
